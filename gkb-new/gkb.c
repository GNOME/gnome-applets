...
loadprop (int i)
{
  ...
  actdata->command = gkb_load_pref (buf, (i?"gkb_xmmap us":"xmodmap ~/.gkb_default.xmm"));
  g_free(buf);
...
do_at_first_run (GKB * gkb) 
{
 ...
 if ((firstrun == NULL) || (!firstrun)) {
  system ("echo \"! This file has generated by Gnome Keyboard applet\" > ~/.gkb_default.xmm");
  system ("xmodmap -pke >> ~/.gkb_default.xmm");
