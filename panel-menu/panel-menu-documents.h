...
#ifndef _PANEL_MENU_DOCUMENTS_H_
#define _PANEL_MENU_DOCUMENTS_H_
...
PanelMenuEntry *panel_menu_documents_new_with_id (PanelMenu *parent, gint id);
...
gchar *panel_menu_documents_save_config (PanelMenuEntry *entry);
void panel_menu_documents_remove_config (PanelMenuEntry *entry);
