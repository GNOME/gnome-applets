...
#ifndef _PANEL_MENU_ACTIONS_H_
#define _PANEL_MENU_ACTIONS_H_
...
PanelMenuEntry *panel_menu_actions_new (PanelMenu *parent);
...
gchar *panel_menu_actions_save_config (PanelMenuEntry *entry);
