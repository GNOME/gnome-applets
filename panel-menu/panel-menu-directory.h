...
PanelMenuEntry *panel_menu_directory_new(PanelMenu *parent, gchar *name, gchar *path, gint level);
...
GtkWidget *panel_menu_directory_get_popup(PanelMenuEntry *entry);
