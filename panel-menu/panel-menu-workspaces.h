...
GtkWidget *panel_menu_workspaces_get_checkitem(PanelMenuEntry *entry);
GtkWidget *panel_menu_workspaces_get_popup(PanelMenuEntry *entry);
gchar *panel_menu_workspaces_dump_xml(PanelMenuEntry *entry);
